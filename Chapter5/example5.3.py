...
# Example 5.3 Hybrid scheme for example 5.1
...
print('Example 5.3 Hybrid scheme of example 5.1')
print('-----------------------------------------------------------------------')
...
plt.title("Hybrid differencing scheme with %d nodes" % n)
