...
# Example 5.1 1-D convection-diffusion problem with central differencing scheme; phi_0=1, phi_L=0
...
print('Example 5.1 1-D convection-diffusion problem with central differencing scheme; phi_0=1, phi_L=0')
print('-----------------------------------------------------------------------')
...
plt.title("Central differencing scheme with %d nodes" % n)
